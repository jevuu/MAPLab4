...
public class MainActivity extends AppCompatActivity {
    ...
    int[] leftListImg = {R.drawable.santa_claus, R.drawable.rain_umbrella, R.drawable.picket_fence,
    ...
    int[] rightListImg = {R.drawable.cigarette_lighter, R.drawable.house_home, R.drawable.desk_lamp,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leftList.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                ...
                intent.putExtra("itemName", leftListString[position]);
                intent.putExtra("itemImage", leftListImg[position]);
        ...
        rightList.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                Intent intent = new Intent(getApplicationContext(), DetailsActivityRight.class);
                intent.putExtra("itemName", rightListString[position]);
                intent.putExtra("itemImage", rightListImg[position]);
                intent.putExtra("itemAlpha", alpha[position]);
                startActivity(intent);
            }
        });
    }
